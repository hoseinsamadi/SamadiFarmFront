...
export const BRAND = {
  name: "صمدی فارم",
  tagline: "زنبورستان خانوادگی از ۱۳۵۲",
};
...
export const HERO = {
  eyebrow: "زنبورستان خانوادگی صمدی — از ۱۳۵۲",
  titleLines: ["طعمِ واقعی عسل،", "مستقیم از", "کندو تا سفره"],
  highlightWord: "کندو",
  desc: "عسل‌های تک‌گل و چندگیاه، شهد موم، ژل رویال و بره‌موم؛ همه‌ی فرآورده‌های کندو با برداشت محدود و درب‌مومِ همان روز، بی‌هیچ واسطه‌ای از ییلاقات دماوند و سبلان به خانه‌ی شما می‌رسد.",
  ctaPrimary: "خرید از برداشت تازه",
  ctaSecondary: "داستان سه نسل ما",
  ...
  captionTitle: "برداشت تازه‌ی پاییز ۱۴۰۴",
...
export const TICKER_ITEMS = [
  ...
  "ارسال رایگان بالای ۹۰۰ هزار تومان",
...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    icon: "gift",
    title: "بسته‌ی هدیه",
    desc: "جعبه‌ی چوبیِ سه شیشه با کارت دست‌نویس؛ هدیه‌ای به شیرینی عسل.",
    scrollTo: "order",
  },
];
...
export const STORY = {
  eyebrow: "داستان ما",
  title: "سه نسل، یک وسواس: عسلِ واقعی",
  copy: "صمدی فارم یک برند نیست؛ یک خانواده است. از دو کندوی چوبی پدربزرگ در سال ۱۳۵۲ تا ۱۴۰ کندوی امروز در سه ییلاق، راهِ عسل برای ما عوض نشده است: صبر، کوچ با فصل‌ها و دست‌نزدن به خلوص.",
...
export const TIMELINE = [
  {
    year: "۱۳۵۲",
    title: "دو کندوی چوبی پدربزرگ",
    desc: "حاج قاسم صمدی اولین کندوها را در دامنه‌ی دماوند ساخت؛ عسل را با اسب به بازار می‌برد.",
  },
  {
    year: "۱۳۷۸",
    title: "نسل دوم پشت کندوها",
    desc: "رحیم صمدی زنبورستان را بزرگ‌تر کرد و کوچِ فصلی به مراتع سبلان را شروع کرد.",
  },
  {
    year: "۱۳۹۸",
    title: "عسل‌های تک‌گل سبلان",
    desc: "با افزودن مراتع سبلان، آویشن و گون به خانواده‌ی محصولات اضافه شدند.",
  },
  {
    year: "۱۴۰۲",
  ...
  {
    year: "امروز",
    title: "۱۴۰ کندو، سه ییلاق",
    desc: "دماوند، سبلان و سهند؛ و شما که با هر شیشه، بخشی از این قصه را می‌چشید.",
  },
];
