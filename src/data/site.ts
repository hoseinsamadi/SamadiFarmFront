...
export const HERO = {
  ...
  highlightWord: "کندو",
  desc: "عسل‌های تک‌گل و چندگیاه، شهد موم، ژل رویال و بره‌موم؛ همه‌ی فرآورده‌های کندو با برداشت محدود و درب‌مومِ همان روز، بی‌هیچ واسطه‌ای دشت قزوین و الموت طارم به خانه‌ی شما می‌رسد",
